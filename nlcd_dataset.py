...
class NlcdDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_nlcd_dataset = NlcdDataset(data=train_rows, cvusa_root=self.cvusa_root, tfms=self.tfm)
        self.valid_nlcd_dataset = NlcdDataset(data=valid_rows, cvusa_root=self.cvusa_root, tfms=self.tfm)
